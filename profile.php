                    ...
                    <div class="mx-auto" style="width: 140px;">
                      <div class="d-flex justify-content-center align-items-center rounded"
                        ...
                        <span style="color: rgb(166, 168, 170); font: bold 8pt Arial;"><img class="card-img-top"
                            src="./admin/users/images/<?php  echo  $pro['user_img']?>"></span>
                          ...
                          <div class="col">
                            <div class="form-group">
                              ...
                              <input class="form-control" type="text" name="address" placeholder=""
                                value="<?php echo  $pro['user_address'] ?>">
                            </div>
                          </div>
                        </div>
                      </div>
                    ...
                    <div class="row">
                      <div class="col d-flex justify-content-end">
                        <button class="btn btn-primary" type="submit" name="update"
                          style="background:#717ce8;margin-right:10px;">Save Changes</button>
                        </form>
                        <form action="" method="post">
                          <a href=""><button class="btn btn-primary" name="orders" type="submit"
                              style="background:#717ce8">Show orders</button></a>
                        </form>
                      </div>
                    </div>
        ...
        <div class="col-12 col-md-3 mb-3">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <button type="button" class="btn btn-primary" style="background:#717ce8"><a href="./about.php"
                  style="color:white">Contact Us</a></button>
            </div>
          </div>
        </div>
      </div>
